...
class Mol2SetEncoder(Encoder):
    def __init__(self) -> Encoder:
        super().__init__("Mol2SetEncoder")
    ...
    def sentences2set(self, sentences: List, unseen="UNK") -> np.ndarray:
    ...
    def encode(
        ...
        **kwargs,
        ...
        for smi in smiles:
            ...
            sentence_set = self.sentences2set([sentence])[0]
