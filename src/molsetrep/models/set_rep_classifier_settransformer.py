...
class SetRepClassifierSetTransformer(torch.nn.Module):
    # changed
    def __init__(self, n_hidden_sets, n_elements, d, n_classes):
        super(SetRepClassifierSetTransformer, self).__init__()
        self.d = d
        ...
        ### added
        self.set_trans = SetTransformer(self.d, n_hidden_sets, n_classes)
        ## removed
        # self.init_weights()
