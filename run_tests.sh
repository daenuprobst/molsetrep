...
# python scripts/molnet_test_runner.py bbbp msr1 --task-type classification --splitter scaffold --n 10 --max-epochs 100 --project gine-baselines --no-charges --variant no_charges
# python scripts/molnet_test_runner.py bbbp msr2 --task-type classification --splitter scaffold --n 10 --max-epochs 100 --project gine-baselines --no-charges --variant no_charges
# python scripts/molnet_test_runner.py bbbp msr3 --task-type classification --splitter scaffold --n 10 --max-epochs 100 --project gine-baselines --no-charges --variant no_charges

# python scripts/molnet_test_runner.py freesolv msr1 --n 10 --max-epochs 100 --project gine-baselines --no-charges --variant no_charges
# python scripts/molnet_test_runner.py freesolv msr2 --n 10 --max-epochs 100 --project gine-baselines --no-charges --variant no_charges
# python scripts/molnet_test_runner.py freesolv msr3 --n 10 --max-epochs 100 --project gine-baselines --no-charges --variant no_charges
