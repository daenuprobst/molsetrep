...
from molsetrep.models.gine import GATE


class GNNSetRepClassifierGAT(torch.nn.Module):
    def __init__(
        self,
        in_channels: int,
        hidden_channels: int,
        ...
        super(GNNSetRepClassifierGAT, self).__init__()
        ...
        if self.gnn is None:
            if self.in_edge_channels > 0:
                ...
                self.gnn = GATE(in_channels, hidden_channels, num_layers)
...
class GNNSetRepClassifierGCN(torch.nn.Module):
    def __init__(
        self,
        in_channels: int,
        hidden_channels: int,
        ...
        super(GNNSetRepClassifierGCN, self).__init__()
