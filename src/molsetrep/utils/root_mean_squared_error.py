...
TRootMeanSquaredError = TypeVar("TRootMeanSquaredError")


class RootMeanSquaredError(Metric[torch.Tensor]):
    """
    ...
    @torch.inference_mode()
    def compute(self: TRootMeanSquaredError) -> torch.Tensor:
        """
    ...
    @torch.inference_mode()
    def merge_state(
        self: TRootMeanSquaredError, metrics: Iterable[TRootMeanSquaredError]
    ) -> TRootMeanSquaredError:
