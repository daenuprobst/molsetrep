...
from molsetrep.models import DeepSet


class GNNDeepSetClassifier(torch.nn.Module):
    def __init__(
        self,
        in_channels: int,
        hidden_channels: int,
        ...
        super(GNNDeepSetClassifier, self).__init__()
        ...
        self.deep_set = DeepSet(self.d, 4, n_classes)
