...
# -> was here -> python scripts/molnet_test_runner.py ocelot srgnn --splitter scaffold --n 2 --max-epochs 150 --project gine-baselines --n-hidden-channels 64 --n-hidden-channels 32 --no-charges --variant no_charges
...
# python scripts/molnet_test_runner.py ocelot msr1 --splitter scaffold --n 2 --max-epochs 150 --project gine-baselines --no-charges --variant no_charges --n-hidden-sets 64 --n-hidden-sets 64 --learning-rate 0.01
...
python scripts/molnet_test_runner.py doyle msr2 --splitter scaffold --n 2 --max-epochs 250 --project gine-baselines --n-hidden-sets 32 --n-hidden-sets 32 --n-elements 16 --n-elements 16 --n-hidden-channels 128 --n-hidden-channels 32 --no-charges --variant fp-2048 --split-ratio 0.5
python scripts/molnet_test_runner.py doyle msr2 --splitter scaffold --n 2 --max-epochs 250 --project gine-baselines --n-hidden-sets 32 --n-hidden-sets 32 --n-elements 16 --n-elements 16 --n-hidden-channels 128 --n-hidden-channels 32 --no-charges --variant fp-2048 --split-ratio 0.25