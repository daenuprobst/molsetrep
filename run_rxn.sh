...
# Doyle
############
# python scripts/molnet_test_runner.py doyle_test msr2 --monitor loss --splitter scaffold --n 4 --start-n 8 --max-epochs 450 --project rxn-final --n-hidden-sets 64 --n-hidden-sets 64 --n-elements 4 --n-elements 4 --batch-size 16 --variant include-chirality
# python scripts/molnet_test_runner.py doyle_test msr2 --monitor loss --splitter scaffold --n 4 --start-n 12 --max-epochs 450 --project rxn-final --n-hidden-sets 64 --n-hidden-sets 64 --n-elements 4 --n-elements 4 --batch-size 16 --variant include-chirality
